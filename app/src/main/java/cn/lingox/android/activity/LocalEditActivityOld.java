...
//
//public class LocalEditActivityOld extends FragmentActivity implements OnClickListener {
...
//        private ProgressDialog pd = new ProgressDialog(LocalEditActivityOld.this);
//
//        @Override
...
//                            CompressImageUtil.compressImage(FileUtil.getImg(imageUri.getPath(), LocalEditActivityOld.this))));
//                    if (list.size() > 0) {
...
//            if (values[1] != null)
//                Toast.makeText(LocalEditActivityOld.this, values[1], Toast.LENGTH_SHORT).show();
//        }
//
//        @Override
