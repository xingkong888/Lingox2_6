...
// * 创建travel数据
// */
//public class TravelEditActivityOld extends FragmentActivity implements OnClickListener {
...
//            } else {
//                Toast.makeText(TravelEditActivityOld.this, getString(R.string.start_end), Toast.LENGTH_SHORT).show();
...
//            } else {
//                Toast.makeText(TravelEditActivityOld.this, getString(R.string.end_start), Toast.LENGTH_SHORT).show();
//                endDatePickerDialog();
//            }
//        }
//    };
...
//                new TravelPlanAsynTask(TravelEditActivityOld.this, travel, "create").execute();
//            }
//
//            @Override
//            public void onFail() {
//                Toast.makeText(TravelEditActivityOld.this, "Create a failure", Toast.LENGTH_SHORT).show();
//                pd.dismiss();
//            }
//        }).execute();
//    }
...
//            @Override
//            public void onFail() {
//                Toast.makeText(TravelEditActivityOld.this, "Modify the failure", Toast.LENGTH_SHORT).show();
//                pd.dismiss();
//            }
//        }).execute();
//    }
