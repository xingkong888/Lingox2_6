...
public class FollowersAdapter extends ArrayAdapter<User> implements SectionIndexer {
    // Data Elements
    ...
    public FollowersAdapter(Activity context, int resource, ArrayList<User> cList) {
